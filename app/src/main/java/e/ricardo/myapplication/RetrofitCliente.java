...
import e.ricardo.myapplication.APIRetrofit;
...
public class RetrofitCliente {
    ...
    public RetrofitCliente(){
        ...
        OkHttpClient okHttpClient = new OkHttpClient().newBuilder().connectTimeout(20,TimeUnit.SECONDS)
    ...
    public APIRetrofit getrestclient() {
        return REST_CLIENT;
    }
